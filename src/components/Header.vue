    ...
    <div class="bg-transparent py-5 px-10" id="nav">
      <div class="flex justify-between text-white font-bold font-nunito">
        <div class="flex items-center">
          ...
          <svg @click="$store.commit('setShowSidebar')" class="cursor-pointer ml-10 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16"></path></svg>
        </div>
        <button @click="logoutButton()" class="dark-btn">
